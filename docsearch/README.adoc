...
:idseparator: -
// Project URLs:
:url-repo: https://github.com/Apicurio/apicurio-docs-playbook
// External URLs:
...
This guide contains information for how to manage the search index for the Apicurio documentation site.
...
The search index for the documentation is hosted by {url-algolia}[Algolia] in the Apicurio application.
The name of the index is *apicurio-docs*.
...
This configuration file is located in the playbook repository for the Apicurio documentation.
